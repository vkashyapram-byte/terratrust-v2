...
import { ShieldCheck, MapPinned, Sparkles, type LucideIcon } from "lucide-react";
      ...
      <div className="relative hidden overflow-hidden border-l border-border bg-surface-elevated lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <p className="max-w-md text-xs text-muted-foreground">
            "We resolved 612 disputed parcels in our first quarter on TerraTrust." — Director,
...
function Feat({ icon: Icon, t }: { icon: LucideIcon; t: string }) {
  return (
