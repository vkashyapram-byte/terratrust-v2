    ...
    <div className="grid gap-4 lg:grid-cols-[1fr_340px]">
      <div className="surface-card p-5">
        ...
        {fallbackReason && (
          <p className="mt-2 text-xs text-warning-foreground">
            n8n webhook configured but unreachable ({fallbackReason}) — deterministic simulation
            used instead.
          </p>
        )}
        <div className="mt-4">
          ...
          <>
            <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <SignalTile
                ...
                value={`${result.fraudBand ?? "Pending"} · ${result.fraudScore ?? 0}`}
                tone={
              ...
              <SignalTile
                ...
                value={`${result.riskScore ?? 0}/100`}
                tone={(result.riskScore ?? 0) >= 45 ? "warning" : "success"}
              />
            </div>
      ...
      <div className="surface-card flex flex-col items-center p-5">
        ...
        <div className="mt-6 w-full space-y-3">
          ...
          <ConfidenceMeter
            value={result?.fraudScore != null ? 100 - result.fraudScore : 0}
            label="Fraud clearance"
          />
          <ConfidenceMeter
            value={result?.riskScore != null ? 100 - result.riskScore : 0}
