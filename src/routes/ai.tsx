...
const modules = [
  ...
  },
  {
    ...
    desc: "Multi-temporal imagery change detection.",
    stat: "12 epochs",
    tag: "Fresh 4d",
  },
  {
    ...
    desc: "NDVI, moisture, erosion, soil carbon, slope.",
    stat: "B+ / 78",
    tag: "Healthy",
  },
  {
    ...
    >
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <AIInsightCard
          ...
          title="Land health avg."
          value="78"
          delta={{ value: 2, label: "MoM" }}
          hint="NDVI + moisture composite"
          tone="success"
        />
      </div>
