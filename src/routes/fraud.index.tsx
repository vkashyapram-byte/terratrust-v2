...
const cases = [
  {
    ...
    risk: 92,
    kind: "Duplicate registered deed",
    flagged: "2024-09-21",
    status: "Open",
  },
  {
    ...
    risk: 78,
    kind: "Cadastral boundary overlap",
    flagged: "2024-09-18",
  ...
  },
  {
    ...
    risk: 55,
    kind: "PAN/Aadhaar identity mismatch",
    flagged: "2024-09-12",
    status: "Under review",
  },
  {
    ...
    risk: 33,
    kind: "Stale village survey sketch",
    flagged: "2024-09-10",
    status: "Closed",
  },
];
  ...
  return (
    ...
    >
      <div className="mb-4 rounded-lg border border-border/80 bg-muted/20 px-4 py-2 text-xs text-muted-foreground">
        <strong className="text-foreground">FRAUD ANOMALY ENGINE:</strong> Evidentiary discrepancy
        detector testing document watermarks, duplicate survey numbers, and polygon geometry
        intersections.
      </div>
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              ...
              label: "Risk Score",
              render: (r) => (
                <Pill tone={r.risk > 80 ? "danger" : r.risk > 60 ? "warning" : "info"}>
                  {r.risk}
                </Pill>
              ),
            },
            {
              key: "flagged",
              label: "Flagged Date",
              render: (r) => <span className="text-muted-foreground text-xs">{r.flagged}</span>,
            },
            {
              key: "status",
              label: "Status",
