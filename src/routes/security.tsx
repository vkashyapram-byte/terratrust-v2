      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="surface-card p-5">
          ...
          <Button
            ...
            onClick={() =>
              toast.error(
                "Password management requires Supabase Auth, which is not configured in this build.",
              )
            }
          >
            Change password
        ...
        <div className="surface-card p-5">
          ...
          <Button
            ...
            onClick={() =>
              toast.error(
                "Two-factor authentication management requires Supabase Auth, which is not configured in this build.",
              )
            }
          >
            Manage 2FA
              ...
              >
                ...
                {s.current ? (
                  ...
                  <Button
                    ...
                    onClick={() =>
                      toast.error(
                        "Remote session management requires Supabase Auth, which is not configured in this build.",
                      )
                    }
                  >
