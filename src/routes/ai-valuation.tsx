...
const comps = [
  ...
  { id: "C-4", addr: "Outer Ring Road, Marathahalli", area: 600, price: 2.8, dist: 0.7 },
  { id: "C-5", addr: "Banerghatta Main Rd", area: 530, price: 2.4, dist: 0.9 },
];
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 rounded-lg border border-primary/20 bg-primary/5 px-4 py-2.5 text-xs text-muted-foreground flex items-center justify-between">
        <span>
          <strong className="text-foreground">AI VALUATION ENGINE:</strong> Machine learning
          valuation based on registered circle rates, sub-registrar transaction datasets, and
          infrastructure corridors. Non-binding estimate; not an official government legal title
          valuation.
        </span>
        ...
        <div className="surface-card p-6">
          ...
          <form className="mt-5 grid gap-4">
            ...
            <Button className="mt-2">
              <Sparkles className="h-4 w-4 mr-1" /> Run AI Valuation
            </Button>
          </form>
          ...
          <div className="mt-6 space-y-3">
            <ConfidenceMeter
              ...
              hint="Tight comp-set · verified deed registry"
            />
            <ConfidenceMeter
              value={86}
              label="Comparable density"
              hint="5 sub-registrar comps within 1km"
            />
            <ConfidenceMeter
              value={88}
              label="Macro stability"
              hint="State guidance value stable"
            />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <AIInsightCard
              ...
              title="Price / m²"
              value="₹45,370"
              hint="vs. corridor median ₹42,800"
              tone="accent"
            />
          </div>
          ...
          <div className="surface-card p-6">
            <SectionTitle
              ...
              description="Reconstructed point estimate with weekly recalibration across registered sales."
            />
            <div className="h-64">
              <ResponsiveContainer>
            ...
            <div className="surface-card p-5">
              ...
              <ul className="mt-4 space-y-2 text-sm">
                {comps.map((c) => (
                  ...
                  >
                    <span className="flex items-center gap-2 text-foreground font-medium text-xs">
                      <Pill>{c.id}</Pill> {c.addr}
                    </span>
                    <span className="text-muted-foreground text-xs">
                      {c.area} m² · ₹{c.price} Cr · {c.dist}km
                    </span>
                  </li>
                ))}
              </ul>
              ...
              steps={[
                {
                  ...
                  detail:
                    "12 candidates → 5 retained after recency, type & distance filters in Bengaluru Urban.",
                },
                {
                  label: "Geographic adjustment",
                  detail: "Indiranagar / Koramangala corridor premium: +18% over district median.",
                },
                {
                  label: "Document trust adjustment",
                  detail: "+3% for verified Registered Sale Deed and Bhoomi survey record match.",
                },
                {
                  label: "Guideline value alignment",
                  detail:
                    "Calibrated against Karnataka Revenue Department 2024 revised circle rates.",
                },
                {
                  label: "Calibration",
                  detail:
                    "Model RMSE 3.8% on holdout transactions. Final point estimate: ₹2.45 Cr ± ₹12 Lakhs.",
                },
              ]}
            />
          </div>
