...
export const Route = createFileRoute("/disputes/")({
  head: () => ({ meta: [{ title: "Disputes & Title Claims — TerraTrust AI" }] }),
...
const disputes = [
  ...
  },
  {
    id: "D-3301",
    parcel: "TT-8814-MYS",
    title: "Disputed survey boundary marker",
    filed: "2024-09-05",
    status: "Open",
    days: 24,
  },
  {
    id: "D-3289",
    parcel: "TT-1132-BLR",
    title: "Forged A-Khata Certificate suspected",
    filed: "2024-08-12",
    status: "Resolved",
    days: 48,
  },
  {
    id: "D-3276",
    parcel: "TT-2401-PN",
    title: "Inheritance share partition dispute",
    filed: "2024-06-19",
...
function DisputesPage() {
  return (
    <AppShell
      ...
      subtitle="Track and resolve property disputes with full cadastral audit history."
      actions={
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: "days",
              label: "Days open",
              render: (r) => <span className="text-muted-foreground">{r.days}d</span>,
            },
            {
              key: "status",
              label: "Status",
