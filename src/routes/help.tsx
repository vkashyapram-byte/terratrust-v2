  ...
  component: () => (
    <AppShell title="Help center" subtitle="Guides, answers, and a way to reach a human.">
      <div className="surface-card relative overflow-hidden p-8 hero-gradient">
        ...
        <div className="relative mt-4 max-w-xl">
          ...
          <Input
            ...
            placeholder="Search articles, like 'upload deed' or 'trust score'"
          />
        </div>
      </div>
        ...
        {[
          {
            i: BookOpen,
            t: "Getting started",
            d: "Set up your first Property Passport in under 10 minutes.",
          },
          {
            i: MessageSquare,
            t: "Verification",
            d: "How attestations, OCR, and trust scoring work.",
          },
      ...
      <Accordion type="single" collapsible className="surface-card divide-y divide-border p-2">
        {[
          [
            "How do I upload a deed?",
            "Open the property, go to Documents, then click Upload. Supported formats: PDF, JPG, PNG.",
          ],
          [
            "What does my trust score mean?",
            "It's a 0–100 explainable score combining documents, GIS, community attestations, taxes, and conflict checks.",
          ],
          [
            "Why is my property pending?",
            "Pending means at least one verification source (document, boundary, or attestation) hasn't completed yet.",
          ],
          [
            "How is data protected?",
            "Records are cryptographically signed; access is role-based; every change is auditable.",
          ],
        ].map(([q, a], i) => (
