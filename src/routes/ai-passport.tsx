  ...
  return (
      ...
      actions={
        <>
          <Button variant="outline" asChild>
            <Link
              to="/properties/$id/share"
              params={{ id: "c63deb92-22df-4cb7-903c-25866f7d6aa0" }}
            >
          ...
          <Button asChild>
            <Link
              ...
              params={{ id: "c63deb92-22df-4cb7-903c-25866f7d6aa0" }}
            >
              <Download className="h-4 w-4 mr-1" /> Download Passport
            </Link>
          </Button>
        </>
      }
    >
      <div className="mb-4 rounded-lg border border-border/80 bg-muted/20 px-4 py-2 text-xs text-muted-foreground">
        <strong className="text-foreground">DIGITAL PROPERTY PASSPORT:</strong> Machine-verifiable
        identity combining sub-registrar deeds, cadastral survey, and AI forensic trust checks.
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
        <div className="surface-card relative overflow-hidden p-6">
          ...
          <div className="relative">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Indiranagar Residence, Bengaluru · 540 m²
            </p>
        ...
        <div className="space-y-6">
          <VerdictBanner
            verdict="trusted"
            headline="This Property Passport is authenticated."
            detail="All four AI verifiers agree: registered deed, cadastral boundary, ownership chain, and treasury stamp checks pass within tolerance."
          />
          ...
          <div className="surface-card p-6">
            ...
            <ReasoningTrace
              steps={[
                {
                  label: "Deed OCR extraction",
                  detail: "Registered Sale Deed extracted with 99% character confidence.",
                },
                {
                  label: "Sub-registrar Kaveri reconciliation",
                  detail: "Confirmed volume and page registry records with zero encumbrance flags.",
                },
                {
                  label: "Boundary alignment",
                  detail: "Centroid matches Bhoomi survey map naksha within 0.4m tolerance.",
                },
                {
                  label: "Cadastral ground validation",
                  detail: "Licensed surveyor boundary capture signed with sub-registrar naksha.",
                },
              ]}
            />
          </div>
