    ...
    <div className="surface-card p-6">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Button asChild className="rounded-full">
          <Link to="/properties/$id/verify" params={{ id: "p_001" }}>
            Test workflow · TT-8421-LG
          </Link>
        </Button>
        <Button asChild variant="outline" className="rounded-full">
          <Link to="/properties/$id/verify" params={{ id: "p_003" }}>
            Human-review path · TT-5512-AB
          </Link>
        </Button>
        <Button asChild variant="outline" className="rounded-full">
        ...
        {integrations.map((i) => (
          <div key={i.name} className="surface-card p-5">
            ...
            <Button
              ...
              onClick={() =>
                toast.error(
                  `${i.name} configuration requires the server-side integrations service, which is not configured in this build.`,
                )
              }
            >
