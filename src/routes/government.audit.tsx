...
const rows = [
  ...
  },
  {
    at: "2024-09-25 13:08",
    actor: "TerraTrust AI",
    action: "Flagged duplicate deed",
    target: "TT-5512-AB",
    ip: "system",
  },
  {
    at: "2024-09-25 11:42",
    actor: "Officer T. Owolabi",
    action: "Reassigned dispute D-3318 to mediator",
    target: "D-3318",
    ip: "102.89.x.x",
  },
  {
...
function Page() {
  return (
    <AppShell
      title="Audit log"
      subtitle="Immutable record of every officer and AI action on the registry."
    >
      <KpiRow
        items={[
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: "ip",
              label: "IP",
              render: (r) => <span className="text-muted-foreground">{r.ip}</span>,
            },
          ]}
        />
      </div>
