...
function Dashboard() {
  return (
    <AppShell
      ...
      actions={
        <>
          <Button variant="outline" className="rounded-full"><Sparkles className="h-4 w-4" /> Run AI valuation</Button>
          <Button className="rounded-full"><Plus className="h-4 w-4" /> New Property Passport</Button>
        </>
      }
    >
