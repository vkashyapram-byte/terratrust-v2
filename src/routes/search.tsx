...
function SearchPage() {
  ...
  return (
    <AppShell
      title="Smart Search"
      subtitle="Find any property by passport ID, GPS coordinates, registered owner, survey number, or locality."
    >
      <div className="surface-card p-6">
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          <Button className="h-12">
            <Sparkles className="h-4 w-4 mr-1" /> Search Registry
          </Button>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-0.5 text-[11px] text-muted-foreground">
                Owner: {p.owner} · {p.coords.lat.toFixed(4)}° N, {p.coords.lng.toFixed(4)}° E
              </p>
            </div>
