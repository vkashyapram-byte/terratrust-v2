...
const rows = [
  {
    id: "A-7741",
    parcel: "TT-8421-LG",
    attester: "Mrs. T. Aluko",
    relation: "Neighbour, 18y",
    result: "Confirmed",
    at: "2024-09-23",
  },
  {
    id: "A-7720",
    parcel: "TT-8421-LG",
    attester: "Chief E. Sharma",
    relation: "Community elder",
    result: "Confirmed",
    at: "2024-09-20",
  },
  {
        ...
        <DataTable
          ...
          columns={[
            ...
            { key: "attester", label: "Attester", render: (r) => r.attester },
            {
              key: "relation",
              label: "Relation",
              render: (r) => <span className="text-muted-foreground">{r.relation}</span>,
            },
            {
              key: "at",
              label: "Date",
