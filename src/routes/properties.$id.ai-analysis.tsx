...
const factors = [
  {
    ...
    value: 94,
    note: "Premium corridor — Indiranagar / Koramangala, Bengaluru",
  },
  {
    label: "Document completeness",
    value: 100,
    note: "Sale deed, survey plan, tax receipt, identity on file",
  },
  ...
  { label: "Ownership clarity", value: 99, note: "Single owner registered since 2019" },
  {
    ...
    value: 88,
    note: "Verified transactions recorded nearby in last 90 days",
  },
  {
    label: "Risk indicators",
    value: 96,
    note: "No active disputes, clear encumbrance certificate",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 rounded-lg border border-primary/20 bg-primary/5 px-4 py-2 text-xs text-muted-foreground flex items-center justify-between">
        <span>
          <strong className="text-foreground">AI FORENSIC ANALYSIS:</strong> Explainable AI model
          outputs. AI estimates are non-binding and do not replace official government sub-registrar
          stamp duty or revenue valuations.
        </span>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="surface-card p-5 lg:col-span-2">
          <h3 className="flex items-center gap-2 font-display text-xl">
            <Sparkles className="h-5 w-5 text-primary" /> Score factors
          </h3>
        ...
        <div className="space-y-3">
          ...
          <div className="surface-card p-5">
            <p className="flex items-center gap-2 text-sm font-medium">
              <AlertTriangle className="h-4 w-4 text-warning-foreground" /> Watchouts
            </p>
            <ul className="mt-2 space-y-1 text-xs text-muted-foreground">
          ...
          <div className="surface-card p-5">
            <p className="flex items-center gap-2 text-sm font-medium">
              <TrendingUp className="h-4 w-4 text-primary" /> Outlook
            </p>
            <p className="mt-2 text-xs text-muted-foreground">
              +7.2% projected appreciation in 12 months based on Karnataka urban corridor
