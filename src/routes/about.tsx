...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — TerraTrust AI" },
      {
        name: "description",
        content: "Our mission: a verifiable digital identity for every parcel of land on Earth.",
      },
    ],
  }),
  component: Page,
...
const team = [
  {
    ...
    bio: "20y in cadastral systems, ex-Survey of India advisor.",
  },
  {
    name: "Kushal Santhosh",
    role: "CTO · AI & Systems",
    bio: "Built TerraTrust's Geo-Spatial Cadastral Engine & AI pipeline.",
  },
  {
    name: "Dr. Vandana Rao",
    role: "Head of Policy",
    bio: "Former advisor on Karnataka Bhoomi digital land governance.",
  },
  {
    name: "Amit Deshmukh",
    role: "Head of Design",
    bio: "Shipped enterprise fintech and civic infrastructure products.",
  },
];
      ...
      <main className="px-6 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="font-display mt-2 text-6xl leading-[1.05]">
            A verifiable identity for every parcel of land.
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            We started TerraTrust because billions of people work and live on land they cannot prove
            they own. AI and open registries change that.
          </p>
        </div>
        <div className="mx-auto mt-16 grid max-w-5xl gap-4 md:grid-cols-3">
          {[
            ...
            <div key={s.label} className="surface-card p-6 text-center">
              ...
              <p className="font-display mt-2 text-3xl">{s.v}</p>
            </div>
          ))}
        </div>
