        ...
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 space-y-3 text-sm">
              ...
              <p className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-primary" /> +91 80 4123 4567
              </p>
              <p className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-primary" /> Bengaluru, New Delhi, Mumbai
              </p>
            </div>
          </div>
          <form className="surface-card grid gap-3 p-6">
            ...
            <Field label="Organisation (optional)">
              <Input placeholder="Bureau, bank, NGO…" />
            </Field>
            <Field label="How can we help?">
              <Textarea rows={5} placeholder="Briefly describe what you're after." />
            </Field>
