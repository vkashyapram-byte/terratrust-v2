  ...
  return (
    <AppShell title="Success" subtitle="Your Property Passport has been minted.">
      <div className="surface-card flex flex-col items-center justify-center gap-3 px-6 py-20 text-center">
        ...
        <p className="max-w-md text-sm text-muted-foreground">Authoritative AI valuation and cadastral records have been synchronized with your portfolio.</p>
        <div className="mt-2 flex gap-2">
          <Link to="/properties"><Button>View My Properties</Button></Link>
