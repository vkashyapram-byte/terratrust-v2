    ...
    >
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <AIInsightCard
          ...
          title="High-severity"
          value="1"
          hint="Duplicate polygon — TT-7710-BLR"
          tone="danger"
        />
        <AIInsightCard
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
        <div className="space-y-6">
          <VerdictBanner
            ...
            detail="TT-7710-BLR shares 12% of its polygon with TT-8421-BLR. Recommend dispatching a surveyor for re-measurement."
          />
        ...
        <div className="space-y-6">
          ...
          <div className="surface-card p-5">
            ...
            <Button variant="outline" className="mt-4 w-full">
              <AlertTriangle className="h-4 w-4" /> Run full re-scan
            </Button>
          </div>
        </div>
      </div>
