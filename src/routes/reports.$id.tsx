  ...
  return (
    ...
    >
      ...
      <div className="mb-4 rounded-lg border border-border/80 bg-muted/20 px-4 py-2 text-xs text-muted-foreground">
        <strong className="text-foreground">REGIONAL VALUATION REPORT:</strong> Aggregated spatial
        telemetry and registered sub-registrar transaction indices.
      </div>
      ...
      <div className="mt-6 surface-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          Registered property values across Bengaluru Urban rose 7.2% year-over-year, driven
          primarily by Indiranagar, Whitefield, and the Outer Ring Road tech corridor. Verification
          throughput improved by 18% as more empanelled surveyors onboarded, and disputed parcels
          fell to 1.1% of the active inventory — the lowest recorded in 8 quarters.
        </p>
        ...
        <ul className="mt-2 list-disc space-y-1.5 pl-6 text-xs text-muted-foreground">
          ...
          <li>
            Boundary adjustments concentrated in Bengaluru Rural periphery (58% of regional
            inquiries)
          </li>
          <li>
            AI confidence on agricultural plots improved from 71% → 86% following high-resolution
            Cartosat optical pass
          </li>
          <li>
            Deed anomaly flag rate fell to 0.06% — a multi-year low following DigiLocker e-KYC
            integration
          </li>
        </ul>
