  ...
  return (
    <AppShell title="Bengaluru regional valuation Q3 2024" subtitle={`${id} · Generated 2024-09-22 by TerraTrust AI`}
      ...
      <div className="mt-6 surface-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">Property values in Karnataka rose 6.4% year-over-year, driven primarily by Indiranagar, Koramangala, and Whitefield. Verification throughput improved by 18% as more surveyors onboarded, and disputed parcels fell to 1.2% of the active inventory — the lowest since Q1 2022.</p>
