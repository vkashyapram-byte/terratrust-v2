  ...
  return (
      ...
      actions={
        <>
          <Button variant="outline">
            <Upload className="h-4 w-4 mr-1" /> Upload Deed
          </Button>
          <Button>
    ...
    >
      <div className="mb-4 rounded-lg border border-border/80 bg-muted/20 px-4 py-2 text-xs text-muted-foreground">
        <strong className="text-foreground">FORENSIC OCR ENGINE:</strong> Calibrated on Indian
        bilingual deed templates, e-Stamp certificates, and sub-registrar seal formats.
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_440px]">
        <div className="surface-card p-6">
          <SectionTitle
            ...
            title="Registered Sale Deed & Form 15.pdf"
            action={<AIBadge>OCR Indic v3.1</AIBadge>}
          />
          <div className="relative overflow-hidden rounded-xl border border-border bg-[oklch(0.985_0.005_95)] p-6">
            <div className="absolute right-4 top-4">
              <Pill tone="success">
                <CheckCircle2 className="h-3 w-3 inline mr-1" /> Stamped & Valid
              </Pill>
            </div>
            <p className="text-center text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-semibold">
            ...
            <p className="mt-1 text-center text-xs text-muted-foreground font-mono">
              Ref. KA-BLR-SR-2024-00831
            </p>
            <div className="mt-6 space-y-3 text-sm">
              {ocrFields.map((f, i) => (
                <div
                  key={i}
                  className="group relative rounded-md bg-surface p-2.5 ring-1 ring-primary/15"
                >
        ...
        <div className="space-y-6">
          <VerdictBanner
            ...
            detail="e-Challan stamp matches treasury issue window. Aadhaar, PAN and Sub-Registrar deed references align with registry."
          />
