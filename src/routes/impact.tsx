    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <MetricCard icon={Banknote}   eyebrow="Public finance" label="Estimated annual savings" value={1450}                   prefix="₹"     suffix=" Cr"   hint="Per state land revenue administration — staff, paper, dispute resolution." tone="accent" />
