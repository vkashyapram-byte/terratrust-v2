...
export const valuationFactors = [
  {
    label: "Location desirability (Indiranagar, Bengaluru)",
    weight: 32,
    direction: "up" as const,
    note: "Top 5% premium corridor in Bengaluru Urban district.",
  },
  {
    label: "Recent comparable sales (12 nearby)",
    weight: 24,
    direction: "up" as const,
    note: "Median registered sale ₹2.40 Cr · 90-day window.",
  },
  {
    label: "Verified title chain",
    weight: 14,
    direction: "up" as const,
    note: "Unbroken transfer history since 1998.",
  },
  {
    label: "Guideline value adjustment",
    weight: -9,
    direction: "down" as const,
    note: "State stamp duty revision alignment.",
  },
  {
    label: "Distance to flood risk zone",
    weight: -4,
    direction: "down" as const,
    note: "2.4km from natural drainage buffer.",
  },
  {
    label: "Infrastructure (road + utilities)",
    weight: 11,
    direction: "up" as const,
    note: "60ft asphalt road, BWSSB water, BESCOM grid.",
  },
];
...
export const fraudSignals = [
  {
    ...
    weight: 38,
    direction: "down" as const,
    note: "Polygon checked against Bhoomi registry survey numbers.",
  },
  {
    label: "Document watermark verification",
    weight: 21,
    direction: "down" as const,
    note: "Stamp paper e-Challan verified with Treasury portal.",
  },
  {
    label: "Signature anomaly score",
    weight: 14,
    direction: "down" as const,
    note: "98% biometric & signature match.",
  },
  {
    label: "Revenue department cross-validation",
    weight: 10,
    direction: "up" as const,
    note: "State Land Revenue records acknowledge parcel survey number.",
  },
  {
    label: "Owner verified identity",
    weight: 8,
    direction: "up" as const,
    note: "Aadhaar + PAN verification matched via DigiLocker.",
  },
];
...
export const aiRecommendations = [
  {
    ...
    title: "Upload BBMP property tax receipt 2024-25",
    impact: "+12 trust pts",
    reason: "Closes the documentation gap and unlocks institutional bank loan approvals.",
    cta: "Upload now",
  },
  {
    id: "r2",
    priority: "high" as const,
    title: "Surveyor field verification for Mysuru Farm",
    impact: "Eliminates boundary dispute risk",
    reason: "GIS polygon alignment recommended with Bhoomi survey coordinates.",
    cta: "Open survey request",
  },
  {
    id: "r3",
    priority: "medium" as const,
    title: "Refresh Cartosat / Sentinel-2 satellite scan",
    impact: "+4 confidence pts",
    reason: "Recent optical pass improves boundary detection precision to ±0.2m.",
    cta: "Refresh imagery",
  },
  {
    id: "r4",
    priority: "medium" as const,
    title: "Request neighborhood attestation in Indiranagar",
    impact: "Reaches community gold tier",
    reason: "Properties with ≥3 verified local attestations clear revenue queue 2.4× faster.",
    cta: "Invite attestor",
  },
  {
    id: "r5",
    ...
    reason: "Get notified if any guideline valuation or encumbrance status changes.",
    cta: "Enable",
  },
];
...
export const ocrFields = [
  ...
  { label: "Registration date", value: "14 March 2024", confidence: 98 },
  {
    ...
    value: "Karnataka Department of Stamps & Registration",
    confidence: 98,
  },
...
export const verificationSuggestions = [
  {
    id: "v1",
    action: "Cross-check coordinates with Bhoomi spatial dataset",
    confidence: 98,
    status: "Auto-passed" as const,
  },
  {
    id: "v2",
    action: "Request neighborhood attestation (≥2 resident verifiers)",
    confidence: 85,
    status: "Suggested" as const,
  },
  {
    id: "v3",
    action: "Empanelled surveyor field inspection",
    confidence: 78,
    status: "Suggested" as const,
  },
  {
    id: "v4",
    action: "Sub-registrar Kaveri 2.0 deed verification",
    confidence: 92,
    status: "Auto-passed" as const,
  },
  {
    id: "v5",
    action: "Encumbrance certificate (Form 15) reconciliation",
    confidence: 94,
    status: "Auto-passed" as const,
  },
];
