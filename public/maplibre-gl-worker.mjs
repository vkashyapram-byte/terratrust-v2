    ...
    if (y.length) {
      ...
      (this.inFlightDependencies.push(e),
        (C = i.sendAsync(
          {
            type: `GI`,
            data: { icons: y, source: this.source, tileID: this.tileID, type: `patterns` },
          },
          e,
        )));
    }
...
var le = class {
    ...
    loadVectorTile(e, n) {
      try {
        return { vectorTile: e.encoding === `mlt` ? new k(n) : new w(new t(n)), rawData: n };
      } catch (t) {
    ...
    async reloadTile(e) {
      ...
      if (n.vectorTile)
        return ((n.showCollisionBoxes = e.showCollisionBoxes), await this._parseWorkerTile(n, e));
    }
    async abortTile(e) {
  ...
  ue = class {
    ...
    async loadAndProcessGeoJSON(e, t) {
      ...
      if (e.dataDiff) {
        ((this._geoJSONIndex ??= this._createGeoJSONIndex(
          ...
          this._geoJSONIndex.updateData(e.dataDiff, this._getFilterPredicate(e.filter, e.source)));
        return;
      }
      if (
        (e.updateCluster &&
    ...
    _filterGeoJSON(e, t, n) {
      ...
      return r ? { type: `FeatureCollection`, features: e.features.filter((e) => r(e)) } : e;
    }
