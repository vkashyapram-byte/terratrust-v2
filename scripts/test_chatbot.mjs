...
async function testFullChatbot() {
  ...
  await frame.evaluate(() => {
    const closeBtn = document.querySelector('button.aparsoft-chat__icon-btn[aria-label="Close chat"]');
    closeBtn?.click();
  });
  ...
  console.log('Final screenshot saved to screenshots/map_verification/10_chatbot_final_response.png');
