...
const ARTIFACT_DIR =
  "/Users/kushal/.gemini/antigravity-ide/brain/fb9882bc-49e5-45a9-8260-7cbe30290b5c";
...
async function runVisualChromeWalkthrough() {
  ...
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "step2_geolocation.png"),
    fullPage: false,
  });
  ...
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "step3_real_map_initial.png"),
    fullPage: false,
  });
  ...
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "step3_search_results.png"),
    fullPage: false,
  });
  ...
  if (resultItem) {
    ...
    await new Promise((r) => setTimeout(r, 1500));
    await page.screenshot({
      path: path.join(ARTIFACT_DIR, "step3_search_centered.png"),
      fullPage: false,
    });
  }
  ...
  await new Promise((r) => setTimeout(r, 600));
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "step3_boundary_polygon.png"),
    fullPage: false,
  });
  ...
  await new Promise((r) => setTimeout(r, 800));
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "step5_review_summary.png"),
    fullPage: false,
  });
  ...
  await page.screenshot({
    path: path.join(ARTIFACT_DIR, "submission_success.png"),
    fullPage: false,
  });
